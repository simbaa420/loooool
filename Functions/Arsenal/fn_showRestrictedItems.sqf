...
if (_show) then {
    ...
    if (_showNotification < 0 || _showNotification > 0) then {
        ...
        forEach[IDC_RSCDISPLAYARSENAL_TEMPLATE_BUTTONDELETE, IDC_RSCDISPLAYARSENAL_TEMPLATE_BUTTONCANCEL, IDC_RSCDISPLAYARSENAL_TEMPLATE_VALUENAME, IDC_RSCDISPLAYARSENAL_TEMPLATE_EDITNAME, IDC_RSCDISPLAYARSENAL_TEMPLATE_COLUMN1, IDC_RSCDISPLAYARSENAL_TEMPLATE_COLUMN2, IDC_RSCDISPLAYARSENAL_TEMPLATE_COLUMN3, IDC_RSCDISPLAYARSENAL_TEMPLATE_COLUMN4, IDC_RSCDISPLAYARSENAL_TEMPLATE_COLUMN5];
